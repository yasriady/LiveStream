...
import static org.yasriady.livestream.Cfg.Category.NEWEST;
import static org.yasriady.livestream.Cfg.Category.POPULAR;
 ...
 */
public class PopularFragment extends Base  {

    /* Configure these consts: */
    private final String TABLENAME = "video_popular";
    //private final String TITLE = getResources().getString(R.string.live_now);
    private final Cfg.Category CATEGORY = POPULAR;
    ...
    public static PopularFragment newInstance(String title, String param2) {
