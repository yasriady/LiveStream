...
import static org.yasriady.livestream.Cfg.Category.SEARCH;
 ...
 */
public class SearchFragment extends Base {

    /* Configure these consts: */
    private final String TABLENAME = "BELUM_ADA";
    //private final String TITLE = getResources().getString(R.string.live_now);
    private final Cfg.Category CATEGORY = SEARCH;
